            ...
            >
                ...
                <div className="relative z-10 max-w-lg text-white">
                    ...
                    <p className="text-lg text-white/90 drop-shadow">
                        OpenFamily aide les familles sénégalaises à organiser le quotidien,
            ...
            <div className="flex items-center justify-center p-4 sm:p-8 relative">
                ...
                >
                    <CardHeader className="text-center pb-8 pt-8">
                        ...
                        <CardTitle className="text-3xl mb-3 text-primary">OpenFamily</CardTitle>
                ...
                <p className="absolute bottom-6 text-label-sm text-muted-foreground text-center w-full">
                    &copy; {new Date().getFullYear()} OpenFamily{' '}
                    <a
